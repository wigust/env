...
in
{
  options.services.restic2.backups = mkOption {
    description = ''
    ...
    type = types.attrsOf (types.submodule ({ name, ... }: {
      options = {
        ...
        dynamicFilesFrom = mkOption {
          default = dir: "${pkgs.findutils}/bin/find ${dir}";
          description = ''
      ...
      mapAttrs'
        (name: backup:
          let
            ...
            backupPaths = "--files-from ${filesFromTmpFile}";
            ...
            preStart = ''
              ...
              ${optionalString (backup.dynamicFilesFrom != null) ''
                ${pkgs.writeScript "dynamicFilesFromScript" ''
                  ...
                  ${concatStringsSep "\n" (map backup.dynamicFilesFrom backup.paths)}
                ''} > ${filesFromTmpFile}
              ''}
            '';
        ...
        config.services.restic2.backups;
    systemd.timers =
      mapAttrs'
