{ steam, stdenv, makeDesktopItem, fetchurl, protobuf, writeScriptBin
, autoPatchelfHook, wayland, xorg, qt512, libGL, cups, alsaLib, gstreamer
, gst_plugins_base, bashInteractive }:
