...
values."
  ...
  package-check-signature nil
   ;; If non nil ELPA repositories are contactedµ via HTTPS whenever it's
   ...
   dotspacemacs-configuration-layers '((c-c++ :variables
                                              c-c++-backend 'lsp-cquery
                                              c-c++-lsp-executable "/run/current-system/sw/bin/cquery"))
   ))
